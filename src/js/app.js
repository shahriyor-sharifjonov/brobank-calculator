...
calc.forEach(calculator => {
  const itemWrapper = calculator.querySelector(".calculator__withdraws");
  const addReplenishment = calculator.querySelector(".addReplenishment");
  const addWithdrawal = calculator.querySelector(".addWithdrawal");
  ...
  let depositAmount = calculator.querySelector(".depositAmount").value;
  let depositTerm = calculator.querySelector(".depositTerm").value;
  
  let depositDate = calculator.querySelector(".depositDate");
  
  let endResult = calculator.querySelector(".endResult");
  let yearResult = calculator.querySelector(".yearResult");
  ...
  const setDropdowns = () => {
    const dropdowns = calculator.querySelectorAll(".dropdown");
  ...
  const setRanges = () => {
    const ranges = calculator.querySelectorAll(".calculator__range");
  ...
  const setGraphs = () => {
    const graphBtn = calculator.querySelector(".calculator__footer-btn");
    const graphCon = calculator.querySelector(".calculator__list");
    let graphOpen = false;
  ...
  const setItems = () => {
    const items = calculator.querySelectorAll(".calculator__withdraw");
    items.forEach((el) => {
    ...
    replenishment = `
      ...
      <div class="calculator__withdraw-form"> 
        <div class="calculator__withdraw-item">
          ...
          <input class="calculator__withdraw-input" type="text" value="100000">
        </div>
        <div class="calculator__withdraw-item">
  ...
  if (calculator.querySelector(".choose-symbol")) {
    const buttons = calculator.querySelectorAll(".choose-symbol");
  ...
  if (calculator.querySelector(".calc-frequency")) {
    const buttons = calculator.querySelectorAll(".calc-frequency");
    buttons.forEach((button) => {
      button.addEventListener("click", (e) => {
